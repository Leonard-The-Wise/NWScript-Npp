...
### Menu option - "Compiler settings":
   ...
   - `Neverwinter Nights 1` support any version of the original game and also the Enhanced Edition versions.
...
### Menu option - "User's Preferences":
   ...
   **Remarks**
   ...
   If you cancel one auto-install attempt (because you refused to run Notepad++ as Administrator), no other attempts will be made until the next version of Notepad++ - given, of course that the Auto-Install option is still checked when version changes.
