...
namespace PluginDarkMode
{
	...
	DPIManager _dpiManager;				 // DPI manager for some functions
	Options _options;					 // Actual runtime options
	std::unique_ptr<D2DDarkModeRenderer> _renderer;       // Dark Mode Direct2D renderer
	...
	{
		g_initialized = true;
		_renderer = std::make_unique<D2DDarkModeRenderer>();
